...
SWIGINTERN PyObject *_wrap_ws2811_array_get(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ws2811_channel_t *arg1 = (ws2811_channel_t *) 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:ws2811_array_get",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_ws2811_channel_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ws2811_array_get" "', argument " "1"" of type '" "ws2811_channel_t *""'"); 
  }
  arg1 = (ws2811_channel_t *)(argp1);
  ws2811_array_get(arg1,arg2,arg3);
  resultobj = SWIG_Py_Void();
  {
    npy_intp dims[1] = {
      *arg3 
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "ws2811_array_get", _wrap_ws2811_array_get, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
